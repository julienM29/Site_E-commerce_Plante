  ...
  return (
    <>
      <div className='flex flex-col'>
        <div className="w-full flex justify-center bg-slider-text py-3">
          <div className="w-full max-w-4xl flex flex-col md:flex-row items-center gap-6">
            <p className="md:w-1/2 text-center md:text-left text-xl font-semibold text-white ">
