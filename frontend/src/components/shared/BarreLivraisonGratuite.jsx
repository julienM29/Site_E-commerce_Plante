...
const BarreLivraisonGratuite = ({ prixPanier }) => {
    ...
    let pourcentageBarre ;
    if(pourcentagePrixLivraisonGratuite > 100){
        pourcentageBarre = 100;
    } else {
        pourcentageBarre = pourcentagePrixLivraisonGratuite;
    }
    return (
        <div className='flex flex-col gap-2'>
            ...
            <div className='w-full bg-gray-200 rounded-full h-2.5 dark:bg-gray-600'>
                <div
                    ...
                    style={{ width: `${pourcentageBarre}%` }} // Calcul dynamique du pourcentage
                ></div>
            </div>
        </div>
    );
